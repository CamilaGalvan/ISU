Public Class frmOrdeñeConfig
    ...
    Private Sub insertar(numero As Integer, horainicio As String, horafinal As String)
        sql = "insert into ordeñe values (numero_ordenie, hora_inicio, hora_fin) values (" & numero & ", '" & horainicio & "', '" & horafinal & "')"
        execute_sql()
    End Sub
            ...
            Else
                ...
                While i <= 5
                    If Modifi(i) <> Modifi_now(i) Then
                        Select Case i
                            Case 0
                                sql = "update ordeñe set hora_inicio where numero_ordenie= 1"
                            Case 1
                                sql = "update ordeñe set hora_fin where numero_ordenie= 1"
                            Case 2
                                sql = "update ordeñe set hora_inicio where numero_ordenie= 2"
                            Case 3
                                sql = "update ordeñe set hora_fin where numero_ordenie= 2"
                            Case 4
                                sql = "update ordeñe set hora_inicio where numero_ordenie= 3"
                            Case 5
                                sql = "update ordeñe set hora_fin where numero_ordenie= 3"
                            Case 6
                                If Modifi(i) < Modifi_now(i) Then
                                    Dim aux As Integer
                                ...
                                Else
                                    ...
                                    Select Case aux
                                        Case 1
                                            If Modifi(i) = 1 Then
                                                sql = "delete from ordeñe where num=3"
                                            Else
                                                sql = "delete from ordeñe where num=2"
                                            End If
                                        Case 2
                                            sql = "delete from ordeñe where num=2"
                                            execute_sql()
